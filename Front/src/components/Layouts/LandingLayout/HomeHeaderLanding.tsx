                        ...
                        <div className={`relative  flex w-full items-center px-5 py-2.5 ${ShowTopNav === false ? 'bg-transparent dark:bg-transparent  text-white-light' : 'dark:bg-black bg-white'} `}>
                            <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                                <Link to="/home" className="main-logo flex items-center shrink-0">
                                    <img className="w-6 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo.svg" alt="logo" />
                                                ...
                                                <ul className="!py-0 text-dark dark:text-white-dark w-[300px] sm:w-[350px] divide-y dark:divide-white/10">
                                                    <li onClick={(e) => e.stopPropagation()}>
                                                        <div className="flex items-center px-4 py-2 justify-between font-semibold">
                                                            <h4 className="text-lg">Favorite</h4>
                                                    ...
                                                    {notifications.length > 0 ? (
                                                        <>
                                                                        ...
                                                                        <div className="group flex items-center px-4 py-2">
                                                                            ...
                                                                            <div className="ltr:pl-3 rtl:pr-3 flex flex-auto">
                                                                                <div className="ltr:pr-3 rtl:pl-3">
                                                                                    <h6> Aziz you have add this course to you favorite</h6>
                                                            ...
                                                            <li>
                                                                <div className="p-4">
                                                                    <button className="btn btn-primary block w-full btn-small">See All favorite</button>
                                                                </div>
                                                            </li>
                                                        </>
                                                    ) : (
                                        ...
                                        <div className="dropdown shrink-0 flex">
                                            ...
                                            >
                                                <ul className="bg-white shadow-lg rounded-lg w-[230px] font-semibold text-black">
                                                    ...
                                                    <li className="hover:bg-gray-100">
                                                        <Link to="/teach" className="flex items-center px-4 py-3">
                                                            <span className="text-sm">Teach on TriTrain</span>
                                                        </Link>
                                                    </li>
                                                    <li className="hover:bg-gray-100">
