                    ...
                    <div className="inline-block w-full">
                        <div>
                            ...
                            {userToBlock && (
                                <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-900 bg-opacity-50">
                                    <div className="bg-white p-4 rounded-lg">
                                        <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">Block User</div>
                                        <div className="p-5 text-center">
                                            <div className="text-white bg-danger ring-4 ring-danger/30 p-4 rounded-full w-fit mx-auto">
                                                <IconTrashLines className="w-7 h-7 mx-auto" />
                                            </div>
                                            <div className="sm:w-3/4 mx-auto mt-5">
                                                <h4 className="text-xl font-medium mb-4">Are You Sure? 🤔</h4>
                                                <div className="text-white-dark">
                                                    Are you sure you want to {userToBlock?.etat === 'blocked' ? 'unblock' : 'block'} <strong>{userToBlock?.name}</strong>?
                                                </div>
                                            </div>
                                        </div>
                                        <div className="flex justify-center items-center gap-3 p-5 border-t border-[#ebedf2] dark:border-[#1b2e4b]">
                                            <button type="button" className="btn btn-outline-danger" onClick={confirmBlock}>
                                                {userToBlock?.etat === 'blocked' ? 'Unblock' : 'Block'}
                                            </button>
                                            <button type="button" className="btn btn-outline-secondary" onClick={closeBlockModal}>
                                                Cancel
                                            </button>
                                        </div>
                                    </div>
