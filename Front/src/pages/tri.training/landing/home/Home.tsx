                ...
                <div className="  max-w-[600px] lg:max-w-[900px] w-full my-4">
                    <div className=" lg:grid  lg:grid-cols-2   lg:gap-3  lg:place-items-center flex flex-col-reverse ">
                        <div className="lg:pr-10 ">
                            ...
                            <p className="text-3xl font-semibold font-mono max-lg:text-center lg:leading-normal lg:pr-4 mb-4">Develop your team's skills with Udemy Business</p>
                            <ul className="list-disc ml-[20px] ">
                                <li className="font-semibold text-lg lg:leading-relaxed mb-2">Unlimited access to over 26,000 of the best Udemy courses, anytime and anywhere</li>
                            ...
                            <div className="flex gap-2 text-center">
                                <button className="border bg-[#232526] border-black text-white font-semibold text-lg  w-1/2 lg:w-[200px] h-[45px] mt-4 lg:mr-4 hover:bg-black">
                                    {' '}
                                    Buy Triweb Business
                                </button>
                    ...
                    <div className="lg:grid  lg:grid-cols-2   lg:gap-3  ">
                        ...
                        <div className="flex flex-col mt-20 lg:pl-10  w-full">
                            ...
                            <p className="font-semibold  text-xl leading-relaxed mb-4 max-lg:text-center">
                                Our instructors from around the world teach millions of learners on Udemy. We provide you with the tools and skills needed to teach what you love.
                            </p>
                            <button className="border  bg-[#232526] border-black text-white font-semibold text-lg w-[200px] max-lg:w-full h-[45px] mt-4 mr-4 hover:bg-black">
